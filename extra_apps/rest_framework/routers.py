...
class BaseRouter(object):
    ...
    def get_default_base_name(self, viewset):
        ...
        it from the viewset.
        如果没有指定'base_name',尝试自动从viewset找到对应信息确定base_name
        """
...
class SimpleRouter(BaseRouter):
    ...
    def get_default_base_name(self, viewset):
        ...
        If `base_name` is not specified, attempt to automatically determine
        it from the viewset.
        如果没有指定'base_name'，尝试从viewset里面取出来queryset
        """
        # 查看viewset里是否有queryset,没有赋值None
    ...
    def get_lookup_regex(self, viewset, lookup_prefix=''):
        ...
        # 在viewset里面查找是否有lookup_field,没有就使用默认的pk做为查询关键字
...
class DefaultRouter(SimpleRouter):
    ...
    继承自simpleRouter, 但是也在默认的API root view中添加，在urls里面添加格式后缀
    """
